      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-xl sm:text-2xl text-gray-900 mt-4 font-medium">
              Corporate Communications & Marketing Specialist
            </p>
            <p className="text-lg text-gray-600 mt-6 leading-relaxed">
              Strategic marketer driving adoption, revenue impact, and cross-functional alignment.
              I design campaigns, content, and workflows that help products grow faster and brands communicate smarter.
            </p>
